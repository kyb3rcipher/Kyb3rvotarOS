...
rm sxhkdrc
cd ~/.config/sxhkd/
wget https://raw.githubusercontent.com/kyb3r-bat/configs_Kyb3rvotarOS/master/kyb3r_config/sxhkdrc
...
mkdir .kyb3rvotaros
cd .kyb3rvotaros
wget https://raw.githubusercontent.com/kyb3r-bat/configs_Kyb3rvotarOS/master/kyb3r_config/newwallpaper.jpg
...
wget https://raw.githubusercontent.com/kyb3r-bat/configs_Kyb3rvotarOS/master/bin/wifi_status.sh
chmod +x ~/.config/bin/wifi_status.sh
wget https://raw.githubusercontent.com/kyb3r-bat/configs_Kyb3rvotarOS/master/bin/evil_status.sh
chmod +x ~/.config/bin/evil_status.sh
touch ~/.e
wget https://raw.githubusercontent.com/kyb3r-bat/configs_Kyb3rvotarOS/master/bin/ipconfig_status.sh
chmod +x ~/.config/bin/ipconfig_status.sh
echo -e "\n${morado}[Modulos creados y configurados]${endColour}\n"

# Configurando polybar
cd ~/.config/polybar
wget https://raw.githubusercontent.com/kyb3r-bat/configs_Kyb3rvotarOS/master/kyb3r_config/config
